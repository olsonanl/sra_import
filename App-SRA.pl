...
my $script = Bio::KBase::AppService::AppScript->new(\&process_sra);
...
sub process_sra
{
    ...
    print "Proc sra ", Dumper($app_def, $raw_params, $params);
    ...
    my @cmd = ("p3_sra", "-bin", $fasterq_dump_loc, "-out", $out_dir, "-id", $sra_acc_id);
